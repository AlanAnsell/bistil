...
TASK_SFT="$HDD/experiments/distil/run1/distilbert_dp/${BASE_MODEL_SHORT}_${SOURCE_LANG}_${LANG_SFT_DENSITY}_steps-${LANG_SFT_STEPS}_${LANG_SFT_REG}_${SFT_DENSITY}_epochs-${FULL_FT_EPOCHS}_${SPARSE_FT_EPOCHS}"
