...
TASK_SFT="$HDD/experiments/distil/run1/scratch_dp/${BASE_MODEL_SHORT}_${SOURCE_LANG}_${TARGET_LANG}_layers-${NUM_HIDDEN_LAYERS}_trim-${TRIM_THRESH_SHORT}_steps-${PRETRAINING_MAX_STEPS}_${SFT_DENSITY}_epochs-${FULL_FT_EPOCHS}_${SPARSE_FT_EPOCHS}"
