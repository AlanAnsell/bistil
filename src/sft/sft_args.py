...
class SftArguments:
    ...
    full_weight_decay: Optional[float] = field(
        default=0.0, metadata={"help": "Coefficient of L1 regularisation during full fine-tuning."}
    )
    sparse_weight_decay: Optional[float] = field(
        default=0.0, metadata={"help": "Coefficient of L1 regularisation during sparse fine-tuning."}
    )
    hc_lambda: Optional[float] = field(
        default=0.0, metadata={"help": "Coefficient of L0 regularisation for hard-concrete parameters."}
    )
    ...
    reset_params: bool = field(
        default=False,
        metadata={"help": "Whether to reset non-pruned parameters to their original values after pruning phase.."},
    )
